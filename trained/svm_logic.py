...
class SVMLogic(object):
    def __init__(self):
        super().__init__()
        self.MODEL_NAME = f"{config.PROJECT_BASE_DIR}/model/SVM_model.pkl"
        self.image =f"{config.PROJECT_BASE_DIR}/trained/svm_nb.jpg"
        self.location = f"{config.PROJECT_BASE_DIR}/trained/svm_nb.json"
        self.score = 0.0
    ...
    def train_and_save(self):
        ...
        y_pre_linear = ridge.predict(X_test)
